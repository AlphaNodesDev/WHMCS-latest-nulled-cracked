...
class License
{
    ...
    private $licensekey = "7fs8dgd7gsd9g6tdfyt9d7gds7gtv7s6dfvugdy6ftg7ds6tfgs76dftsd76fsdfs6tgf8sd7gftsd7gt6f8s6s6dfg76ds76stdfytv6tvcx7vxv6vfes";
    ...
    protected function makeCall($url, $query_string, $timeout = 5)
    {
		...
		*/
        ...
        $results["registeredname"] = "ENXF.NET";
        $results["productname"] = "WHMCS ENXF.NET";
        $results["productid"] = "5";
